...
class KeyboardController(DirectObject):
	...
	def __init__(self):
		...
		self.accept("arrow_up", Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowUp-down', self)])
		self.accept("arrow_down",  Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowDown-down', self)])
		self.accept("arrow_left",  Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowLeft-down', self)])
		self.accept("arrow_right", Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowRight-down', self)])
		self.accept("arrow_up-up",    Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowUp-up', self)])
		self.accept("arrow_down-up", Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowDown-up', self)])
		self.accept("arrow_left-up", Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowLeft-up', self)])
		self.accept("arrow_right-up", Event.Dispatcher().broadcast, [Event.Event('E_Key_ArrowRight-up', self)])
		self.accept("page_up", Event.Dispatcher().broadcast, [Event.Event('E_Key_PageUp-down', self)])
